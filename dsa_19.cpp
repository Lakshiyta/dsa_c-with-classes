...
int main(){
    ...
    int b[6]={1,3,5}; //Keeping the array incomplete to see the what will be the outcome result.
    cout<<"Partial Initialized Int Array B :"<<endl;
    for(int y :b) //Shows that for each loop will work according to size of the array and not according
                    //to number of elements initialized in the array.
            cout<<y<<endl;
            cout<<endl;
    float c[6] = {1,2,2.4,3.6,48.54,99.48};
